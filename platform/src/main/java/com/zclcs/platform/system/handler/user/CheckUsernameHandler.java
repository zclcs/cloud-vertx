 ...
 * @author zclcs
 */
public class CheckUsernameHandler extends BasePermissionHandler {

    private final Logger log = LoggerFactory.getLogger(this.getClass());

    private final UserService userService;

    public CheckUsernameHandler(PermissionProvider permissionProvider, UserService userService) {
