package com.zclcs.cloud.lib.discovery.backend;
 ...
 */
public class RedisDiscoveryBackendService implements ServiceDiscoveryBackend {
    ...
    public void init(Vertx vertx, JsonObject configuration) {
        ...
        RedisStarter redisStarter = new RedisStarter(vertx, configuration);
        redis = RedisAPI.api(redisStarter.createClient());
    }
