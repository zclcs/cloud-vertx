package com.zclcs.verify.code.starter.base;
...
public abstract class VerifyCode extends Randoms {
    ...
    private static final String[] FONT_NAMES = new String[]{"actionj.ttf"};
